...
public class Student extends User {
    ...
    private HashMap<String,Integer> quizScore;
    private HashMap<Integer, Integer> quizAttempts;
    ...
    public void initializeQuizAttempts() 
    {
    this.quizAttempts = new HashMap<>();
    }
    public HashMap<Integer, Integer> getQuizAttempts(){
        return quizAttempts;
    }
    
    public HashMap<String,Integer> getQuizScore(){
        return quizScore;
    }
    
    public void setQuizScore(HashMap<String,Integer> quizScore){
